...
And the result of this query is shown in Figure \ref{fig:example1-query}. The intersection of the two complexes is a single triangle, which is highlighted in green in the figure.
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Result of the rendering of Example 1}
