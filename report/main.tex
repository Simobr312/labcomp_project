...
The most immediate improvement would be to extend the DSL syntax to support 3D simplicial complexes, allowing users to define and manipulate tetrahedra and other higher-dimensional simplices. This would not be difficult because the core data structures and operations are already defined in a dimension-agnostic way, and the web interface is already using Three.js, which supports 3D rendering. It just needs a few changes to the grammar and the operations to support 3D coordinates.
